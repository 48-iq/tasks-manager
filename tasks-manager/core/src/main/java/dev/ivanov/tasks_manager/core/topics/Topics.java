...
public class Topics {
    ...
    public static final String USER_CREATION_ROLLBACK_EVENTS_TOPIC = "user-creation-rollback-events-topic";
    public static final String USER_DELETION_ROLLBACK_EVENTS_TOPIC = "user-deletion-rollback-events-topic";
    public static final String USER_CREATION_COMMIT_EVENTS_TOPIC = "user-creation-commit-events-topic";
    public static final String USER_DELETION_COMMIT_EVENTS_TOPIC = "user-deletion-commit-events-topic";

    //group-service
    public static final String GROUP_USER_CREATE_EVENTS_TOPIC = "group-user-create-events-topic";
    public static final String GROUP_USER_CREATED_EVENTS_TOPIC = "group-user-created-events-topic";
