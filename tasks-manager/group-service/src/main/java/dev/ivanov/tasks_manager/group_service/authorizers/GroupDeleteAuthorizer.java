...
@Component
public class GroupDeleteAuthorizer implements AuthorizationManager<RequestAuthorizationContext> {
    @Autowired
    ...
    public AuthorizationDecision check(Supplier<Authentication> authenticationSupplier,
        ...
        if (role == null)
            return new AuthorizationDecision(false);
        var result = role.getAuthorities().stream().anyMatch(a -> a.getName().equals("DELETE_GROUP"));
